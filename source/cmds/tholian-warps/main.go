...
func showUsage() {
	...
	console.Group("Usage: tholian-warps [Action] [Listen] [Tunnel]")
	console.Log("       tholian-warps tunnel  [Listen] [Tunnel]")
	console.Log("       tholian-warps forward [Listen] [Tunnel]")
	console.Log("       tholian-warps gateway [Listen]")
	console.GroupEnd("------")
